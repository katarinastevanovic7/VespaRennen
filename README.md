...
```
cd existing_repo
git remote add origin https://gitlab.com/ateam8120515/vespisti.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ateam8120515/vespisti/-/settings/integrations)
